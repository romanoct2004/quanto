...
<script>
    ...
    var is_using_credit_card = false;
</script>
                ...
                <div class=" top-bar">
                    <div class="fix-tool" >
                        ...
                        <div class="set-div-toggle">
                            ...
                            <input name="is_using_credit_card" type="checkbox" class="set-div-toggle-input" id="is_using_credit_card">
                        </div>
                    </div>
                    <div class="fix-btns">
            ...
            <div class="modal-dialog">
                <div class="mail-modal-content">
                    ...
                    <div class="set-div-toggle for-mail">
                        ...
                        <input name="is_using_credit_card_for_modal" type="checkbox" class="set-div-toggle-input" id="is_using_credit_card_for_modal">
                    </div>
