...
?> 
<script>
    var dis_data='{!! $dis_data !!}';
    var is_using_credit_card = {{ $editData->is_using_credit_card === 0 ? "false" : "true" }};
</script>
<input type="hidden" id="user_id" value="{{Auth::user()->id}}">
            ...
            <div style="width:100%; display: flex; justify-content: center;">
                <div class="top-bar">
                    <div class="fix-tool" >
                        ...
                        <div class="set-div-toggle">
                            <label class="set-div-toggle-label" for="is_using_credit_card">クレジットカード<br>決済の利用</label>
                            <input {{ $editData->is_using_credit_card === 1 ? 'checked' : '' }} name="is_using_credit_card" type="checkbox" class="set-div-toggle-input" id="is_using_credit_card">
                        </div>
                    </div>
    ...
    <div class="form-body" id="form_body">
                ...
                <table cellpadding="1" cellspacing="0" class="main-table">
                    ...
                    <tbody>
                            ...
                            @for ($i = 0; $i < $edit_content->rowCount; $i++)
                                <tr>
                                    ...
                                    <td class="td-a5 reduce-pro-td"> 
                                        <select name="pets" class="reduce-pro" id="reduce_pro_{{ $i }}">
                                            <option value="10">10%</option>
                                            <option value="8">8%(軽減税率)</option>
                                            <option value="8">8%</option>
                                            <option value="0">0%</option>
                                        </select>
                                        <input class="td-a5-input" id="reduce_plus_{{ $i }}" value="{{ $edit_content->{ 'reduce_plus_'.$i } ?? 0 }}">円
                                    </td>
                                </tr>
                            @endfor
                        ...
                        <tr>
                            ...
                            <td ></td>
                            <td class="td-r3"><input  class="td-r3-input" id="total_count" value="{{ $edit_content->total_count }}"> </td>
                            <td class="td-r4"> <input  class="td-r4-input" id="total_price" value="{{ $edit_content->total_price }}">円</td>
                            <td class="td-r5"> 消費税(内税)<input  class="td-r5-input" id="reduce_price" value="{{ $edit_content->reduce_price }}">円</td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="other-area">
            <textarea style="height: 100px; border: 1px solid grey; padding: 5px; box-sizing: border-box; margin-left: 10px; font-size: 20px;" placeholder="(備考)" text="afaefafe" id="memo_text">{{ $edit_content->memo_text ?? '' }}</textarea>
            ...
            <div class="detail_price">
                <div>
                    <p>10%対象&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="sinput"id="totalAmount10" value="{{ $edit_content->totalAmount10 }}">円</p>
                    <p>&nbsp;&nbsp;消費税(内税)<input class="sinput"id="totalAmount10s" value="{{ $edit_content->totalAmount10s }}">円</p>
                </div>
                <div>
                    <p>8%(軽減税率)<input class="sinput"id="totalAmount88" value="{{ $edit_content->totalAmount88 }}">円</p>
                    <p>&nbsp;&nbsp;消費税(内税)<input class="sinput"id="totalAmount88s" value="{{ $edit_content->totalAmount88s }}">円</p>
                </div>
                <div>
                    <p>8%対象 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="sinput"id="totalAmount8" value="{{ $edit_content->totalAmount8 }}">円</p>
                    <p>&nbsp;&nbsp;消費税(内税)<input class="sinput" id="totalAmount8s" value="{{ $edit_content->totalAmount8s }}">円</p>
                </div>
            </div>
        </div>
        <style id="page_style">
            ...
            <div class="modal-dialog">
                <div class="mail-modal-content">
                    ...
                    <div class="set-div-toggle for-mail">
                        <label class="set-div-toggle-label" for="is_using_credit_card_for_modal">クレジットカード<br>決済の利用</label>
                        <input {{ $editData->is_using_credit_card === 1 ? 'checked' : '' }} name="is_using_credit_card_for_modal" type="checkbox" class="set-div-toggle-input" id="is_using_credit_card_for_modal">
                    </div>
        ...
        <div class="loading-modal">
          <div class="loading-modal-inner">
            <div class="spinner-border text-primary loading-modal-spinner" role="status"></div>
            <p class="loading-modal-title">PDF生成中...</p>
          </div>
        </div>
