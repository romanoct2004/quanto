...
Route::get('/paper/invoice/pdf/{id}', [PaperController::class, 'invoicePdf'])->name('paper.invoice.pdf');
...
Route::post('/show/reset', [frontendController::class, 'resetCard'])->name('frontend.updateCart')->withoutMiddleware(['auth']);
...
Route::get('/payment_invoice', [frontendController::class, 'showPaymentInvoiceForm'])->name('frontend.paymentInvoice');
Route::post('/payment_invoice', [frontendController::class, 'paymentInvoice'])->name('frontend.paymentInvoice');
